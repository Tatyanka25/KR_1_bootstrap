...
async function getResponce2() {
    ...
    let responce = await fetch("./js/package.json")
    ...
    for (key in content_price) {
                node_for_insert.innerHTML += `
                <li style="width: 320px" class="d-flex flex-column m-1 p-1 border bg-body">
                ...
                <p class="card-text">Цена ${content[key].price} руб.</p>
